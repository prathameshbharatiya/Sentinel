  ...
  return (
    <div className="border border-[#00ff41]/30 bg-zinc-900/40 p-3 flex flex-col h-full overflow-hidden">
      <div className="flex items-center justify-between mb-2 border-b border-zinc-800 pb-1">
        ...
        <span className="text-[8px] opacity-40 uppercase tracking-widest">Agnostic_Kernel</span>
      </div>

      <div className="mb-3 space-y-2">
        <div>
          <div className="text-[7px] text-zinc-500 uppercase mb-1">Active_Platform</div>
          <div className="text-sm font-black text-white uppercase leading-none border-l-2 border-[#00ff41] pl-2">
            {platform.type}
          </div>
        </div>
        ...
        <div>
          ...
          <select 
            ...
            className="w-full bg-black/60 border border-zinc-800 text-[10px] text-white uppercase font-bold p-1 focus:outline-none focus:border-[#00ff41]"
          >
      ...
      <div className="flex-1 space-y-4 overflow-y-auto custom-scrollbar pr-1">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-black/40 border border-zinc-800 p-2 space-y-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-[7px] text-zinc-500 uppercase">Write_Latency</span>
            </div>
            <div className="text-xs font-mono font-bold text-white">
              {platform.actuatorWriteLatencyUs.toFixed(2)} <span className="text-[7px] opacity-40">μs</span>
            </div>
          </div>
          <div className="bg-black/40 border border-zinc-800 p-2 space-y-1">
            <div className="flex items-center gap-1">
              <Zap size={10} className="text-blue-400" />
              <span className="text-[7px] text-zinc-500 uppercase">Read_Latency</span>
            </div>
            <div className="text-xs font-mono font-bold text-white">
              {platform.sensorReadLatencyUs.toFixed(2)} <span className="text-[7px] opacity-40">μs</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-950/60 border border-zinc-800 p-2 space-y-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1">
              ...
              <span className="text-[8px] font-black uppercase text-[#00ff41]">Inner_Loop_Budget</span>
            </div>
            <span className="text-[8px] font-mono text-white">{platform.innerLoopTimingBudgetUs.toFixed(1)} μs</span>
          </div>
          ...
          <div className="text-[6px] text-zinc-500 uppercase italic">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center text-[8px] border-b border-zinc-800 pb-1">
        ...
        <div className="bg-[#00ff41]/5 border border-[#00ff41]/20 p-2 flex items-start gap-2">
          <ShieldCheck size={12} className="text-[#00ff41] shrink-0 mt-0.5" />
          <div className="text-[7px] text-zinc-400 leading-tight">
